      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pb-16">
        <div className="mt-14 rounded-2xl text-white overflow-hidden relative" style={{ background: "linear-gradient(135deg, #182230 0%, #0C121A 100%)" }}>
          ...
          <div className="relative p-8 sm:p-10 grid lg:grid-cols-[1fr_auto] gap-6 items-center">
            <div>
              <span className="inline-flex items-center gap-2 rounded-full bg-white/10 border border-gold-400/40 px-3 py-1 text-xs font-semibold uppercase tracking-wide">
                <GraduationCap className="h-4 w-4 text-gold-300" /> Mini-Store for Schools
              </span>
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <Link href="/school" className="btn-gold px-6 py-3 text-sm">
                Open Mini-Store <ArrowRight className="h-4 w-4" />
              </Link>
              <Link href="/school#manager-login" className="inline-flex items-center justify-center gap-2 rounded-lg border border-gold-400/40 hover:bg-gold-400/10 font-semibold px-6 py-3 text-sm">
                Manager Login
              </Link>
            </div>
          </div>
