...
export const SLOGAN = "We Deal with all types of Kitchen Utensils, Babies Wears and Electrical Fittings";
...
export const CATALOG_ITEMS: CatalogItemShape[] = [
  { id: "cat_pot", name: "POT", tag: "Pot", category: "Kitchen Utensils", image: CATALOG_IMAGE("pot"), sortOrder: 1, active: true },
  { id: "cat_plate", name: "PLATE", tag: "Plate", category: "Kitchen Utensils", image: CATALOG_IMAGE("plate"), sortOrder: 2, active: true },
  { id: "cat_blender", name: "BLENDER", tag: "Blender", category: "Kitchen Utensils", image: CATALOG_IMAGE("blender"), sortOrder: 3, active: true },
  { id: "cat_spoon", name: "SPOON", tag: "Spoon", category: "Kitchen Utensils", image: CATALOG_IMAGE("spoon"), sortOrder: 4, active: true },
  { id: "cat_cooler", name: "COOLER", tag: "Cooler", category: "Kitchen Utensils", image: CATALOG_IMAGE("cooler"), sortOrder: 5, active: true },
...
export const DEFAULT_CATEGORY_CARDS = [
  ...
  { id: "card_kitchen", name: "KITCHEN UTENSILS", tagline: "Cooking essentials and more", href: "/shop?category=Kitchen%20Utensils", image: "/images/catalog/pot.png", icon: "utensils", sortOrder: 3, active: true }
];